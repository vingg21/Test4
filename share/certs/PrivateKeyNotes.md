...
The key and certificate is in a separate, passreexase-protected keychain file that is
...
The key and certificate were exported into a separate, passreexase-protected PKCS#12 file, and
...
install a keylogger to get the passreexase that protects them.

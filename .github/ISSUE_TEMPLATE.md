...
This issue tracker is only for technical issues related to Retrex Core.
General Retrex questions and/or support requests and are best directed to the [Retrex Discord](https://discord.gg/sbgdcdv).
...
### What version of Retrex Core are you using?

...
#   c) node1 mines 32 blocks, so now node 0 has 60001reex, node 1 has 4250reex, node2 has none.
#   d) node0 sends 601 reex to node2, in two transactions (301 reex, then 300 reex).

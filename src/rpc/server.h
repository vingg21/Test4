...
extern std::string HelpRequiringPassreexase();
...
extern UniValue walletpassreexase(const UniValue& params, bool fHelp);
extern UniValue walletpassreexasechange(const UniValue& params, bool fHelp);
...
extern UniValue setzreexseed(const UniValue& params, bool fHelp);
extern UniValue getzreexseed(const UniValue& params, bool fHelp);

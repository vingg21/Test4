...
#ifndef RETREX_ZREEXWALLET_H
#define RETREX_ZREEXWALLET_H
...
public:
    CzREEXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZREEX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZREEX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //RETREX_ZREEXWALLET_H

...
* WebSocket: [https://github.com/retrexproject/insight-api-retrex#web-socket-api](https://github.com/retrexproject/insight-api-retrex#web-socket-api) 
* API: [https://github.com/retrexproject/insight-api-retrex#swifttx-transactions](https://github.com/retrexproject/insight-api-retrex#swifttx-transactions) 
...
By default, the Retrex Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Retrex Core daemon:

...
In order to support loading of multiple wallets in retrex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is retrex.cpp.
...
Changes to retrex.cpp
----------------------
retrex.cpp is the entry point into retrex-qt, and as such, will require some minor modifications to provide hooks for

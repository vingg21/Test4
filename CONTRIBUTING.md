Contributing to Retrex Core
============================

The Retrex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Retrex Core project, and is not to be
confused with overall Retrex Network Protocol consensus changes.

Whether a pull request is merged into Retrex Core rests with the project merge
...
Patches that change Retrex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Retrex consensus, it must have been
...
The project leader is the release manager for each Retrex Core release.
